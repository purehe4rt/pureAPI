...
import eu.pureheart.api.gui.Text;
...
public class Button {
    ...
    public Button setHeadTexture(String value) {
        if (value == null || value.isEmpty()) {
            throw new IllegalArgumentException("[x] Возможно, такая текстура не найдена.");
        }

        ItemMeta meta = this.item.getItemMeta();
        if (meta == null) {
            throw new IllegalStateException("[x] ItemMeta не может быть пустым.");
        }
